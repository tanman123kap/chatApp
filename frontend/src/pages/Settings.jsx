...
const preview_messages = [
  ...
  { id: 2, text: "Doing Great! Just working on some new features.", isSent: true }
];
...
const Settings = () => {
  ...
  const handleSetTheme = (t) => setTheme(t);
  useEffect(() => {
    ...
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
          {themes.map((t) => (
            <button type="button" key={t} className={`cursor-pointer group flex flex-col items-center gap-1.5 p-2 rounded-lg transition-colors ${theme === t ? "bg-base-200" : "hover:bg-base-200/50"}`} onClick={() => handleSetTheme(t)}>
